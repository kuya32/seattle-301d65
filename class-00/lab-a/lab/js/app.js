...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The reason why the previous line of code threw an error is because the variable rando is used only in the block it's defined in.
  console.log(viewed);
